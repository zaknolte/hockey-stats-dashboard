...
def get_agGrid_columnDefs(grid_type:str):
    ...
    if grid_type == "Team":
        column_defs = [
            add_default_number_columnDef("Season", pinned="left", lockPinned=True),
            add_default_number_columnDef("GP", headerTooltip="Games Played"),
            ...
            add_default_number_columnDef("PPG", headerTooltip="Powerplay Goals"),
            add_default_number_columnDef("PPGA", headerTooltip="Goals Against on Powerplay"),
            add_default_number_columnDef("SHG", headerTooltip="Shorthanded Goals"),
            add_default_number_columnDef("SHGA", headerTooltip="Goals Against when Shorthanded"),
            add_default_number_columnDef("PPs", headerTooltip="Powerplay Chances"),
            add_default_number_columnDef("PIMs", headerTooltip="Penalty Minutes"),
            ...
            add_default_number_columnDef("S", headerTooltip="Shots"),
            add_default_number_columnDef("SA", headerTooltip="Shots Against"),
            add_default_number_columnDef("S/G", headerTooltip="Shots Per Game"),
            add_default_number_columnDef("SA/G", headerTooltip="Shots Against Per Game"),
            add_default_number_columnDef("PP S", headerTooltip="Shots on Powerplay"),
            add_default_number_columnDef("PP SA", headerTooltip="Shots Against on Powerplay"),
            add_default_number_columnDef("SH S", headerTooltip="Shots when Shorthanded"),
            add_default_number_columnDef("SH SA", headerTooltip="Shots Against when Shorthanded"),
            add_default_number_columnDef("S %", headerTooltip="Shooting %"),
        ...
        skater_defs = [
            ...
            add_default_number_columnDef("PPG", headerTooltip="Powerplay Goals"),
            add_default_number_columnDef("PPA", headerTooltip="Powerplay Assists"),
            add_default_number_columnDef("SHG",  headerTooltip="Shorthanded Goals"),
            add_default_number_columnDef("SHA", headerTooltip="Shorthanded Assists"),
            add_default_number_columnDef("FO %", headerTooltip="Faceoff %"),
            add_default_number_columnDef("Giveaways", headerTooltip="Giveaways", width=None),
            add_default_number_columnDef("TA", headerTooltip="Takeaways", width=None),
        ...
        goalie_defs = [
            ...
            add_default_number_columnDef("PP SA", headerTooltip="Shots Against on Powerplay"),
            add_default_number_columnDef("PP Saves", headerTooltip="Saves on Powerplay"),
            add_default_number_columnDef("SH SA", headerTooltip="Shots Against when Shorthanded"),
            add_default_number_columnDef("SH Saves", headerTooltip="Saves when Shorthanded"),
            add_default_number_columnDef("G", headerTooltip="Goals"),
            add_default_number_columnDef("A", headerTooltip="Assists"),
            add_default_number_columnDef("P", headerTooltip="Points}"),
        ]
